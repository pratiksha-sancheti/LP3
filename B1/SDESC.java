mport java.awt.datatransfer.StringSelection;
...
public class SDESC {
    ...
    public static int F( int R, int K)
    {
       ...
       t1 = S1[ ((t1 & 0x8) >> 2) | (t1 & 1) ][ (t1 >> 1) & 0x3 ]; //sbox values
...
return ((x & 0xF) << 4) | ((x >> 4) & 0xF);
     ...
     * K1 = P8 (Shift_1 (P10 (Key)))
     ...
     Constructor generates key k1 & k2 used for encyption
     */
     public SDESC( int K) 
   {
	...
	public static void main( String args[]) throws Exception
     {
      ...
      System.out.println("Enter the 10 Bit Key :"); //1011011010
       ...
       String m1="g";
       System.out.println("Letter is:"+m1);
       System.out.println("8 bit Binary representation:");
       int m = Integer.parseInt(SDESC.strToBinary(m1)); //10110110
       System.out.print("\nKey K1: ");
       SDESC.printData( A.K1, 8);
       System.out.print("\nKey K2: ");
       SDESC.printData( A.K2, 8);
       m = A.encrypt( m);
       System.out.print("\nEncrypted Message: ");
       SDESC.printData( m, 8);
